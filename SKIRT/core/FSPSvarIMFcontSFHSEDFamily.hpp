...
#ifndef FSPSvarIMFcontSFHSEDFAMILY_HPP
#define FSPSvarIMFcontSFHSEDFAMILY_HPP
...
/** An instance of the FSPSvarIMFcontSFHSEDFamily class represents a family of composite stellar populations (CSPs)
    forming stars at a constant rate over ten Myr. The templates are generated by the Flexible Stellar Population Synthesis (FSPS)
    code presented by Conroy, Gunn, & White (2009, ApJ, 699, 486) and Conroy & Gunn (2010, ApJ, 712, 833). The SED templates are
    parameterized on metallicity, IMF slope, and are scaled by the formed mass (which corresponds to the SFR times ten Myr) of the CSP.
    ...
    header info): \f[ M_\mathrm{formed}\,(\mathrm{M}_\odot) \quad Z\,(\mathrm{dimensionless}) \quad
    \alpha\,(\mathrm{dimensionless}) \f] */
class FSPSvarIMFcontSFHSEDFamily : public SEDFamily
{
    ITEM_CONCRETE(FSPSvarIMFcontSFHSEDFamily, SEDFamily, "an FSPS variable-IMF SED family for composite stellar populations constantly forming stars over ten Myr")
    ITEM_END()
...
public:
    /** This constructor can be invoked programmatically by classes that use a hard-coded SED
        ...
        */
    explicit FSPSvarIMFcontSFHSEDFamily(SimulationItem* parent);
