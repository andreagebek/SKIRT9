...
#ifndef ZUBKOSMALLGRAPHITEGRAINSIZEDISTRIBUTION_HPP
#define ZUBKOSMALLGRAPHITEGRAINSIZEDISTRIBUTION_HPP

#include "GrainSizeDistribution.hpp"

////////////////////////////////////////////////////////////////////

/** ZubkoSmallGraphiteGrainSizeDistribution represents the dust grain size distribution and grain size
    range for the small graphite population in model BARE_GR_S of Zubko, Dwek & Arendt (2004, ApJS, 152,
...
class ZubkoSmallGraphiteGrainSizeDistribution : public GrainSizeDistribution
{
    ITEM_CONCRETE(ZubkoSmallGraphiteGrainSizeDistribution, GrainSizeDistribution,
                  "a Zubko, Dwek & Arendt size distribution for small graphite dust grains")
    ITEM_END()
...
public:
    ...
    explicit ZubkoSmallGraphiteGrainSizeDistribution(SimulationItem* parent);
