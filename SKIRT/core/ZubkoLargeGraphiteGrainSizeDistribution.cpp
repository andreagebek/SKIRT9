...
ZubkoLargeGraphiteGrainSizeDistribution::ZubkoLargeGraphiteGrainSizeDistribution(SimulationItem* parent)
{
...
double ZubkoLargeGraphiteGrainSizeDistribution::amin() const
{
    return amin_gra;
}
...
double ZubkoLargeGraphiteGrainSizeDistribution::amax() const
{
    return amax_gra;
}
...
double ZubkoLargeGraphiteGrainSizeDistribution::dnda(double a) const
{
    return dnda_gra(a);
}
