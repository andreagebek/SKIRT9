...
#ifndef FSPSnebEmissionSEDFAMILY_HPP
#define FSPSnebEmissionSEDFAMILY_HPP
...
/** An instance of the FSPSSEDFamily class represents a family of single stellar populations (SSPs)
    ...
    White (2009, ApJ, 699, 486) and Conroy & Gunn (2010, ApJ, 712, 833). These templates include nebular emission. The SED templates are
    ...
    t\,(\mathrm{yr}) \f] */
class FSPSnebEmissionSEDFamily : public SEDFamily
{
    ITEM_CONCRETE(FSPSnebEmissionSEDFamily, SEDFamily, "an FSPS SED family for single stellar populations including nebular emission")
    ITEM_END()
...
public:
    /** This constructor can be invoked programmatically by classes that use a hard-coded SED
        ...
        */
    explicit FSPSnebEmissionSEDFamily(SimulationItem* parent);
