...
/** An instance of the FSPSvarIMFSEDFamily class represents a family of single stellar populations (SSPs)
    ...
    parameterized on metallicity, age, IMF slope(s), and are scaled by the initial mass of the SSP.
    The IMF slopes are specified in the mass intervals \f[ M_\mathrm{init}=0.1-0.5\,\mathrm{M}_\odot,\,
    M_\mathrm{init}=0.5-1\,\mathrm{M}_\odot,\,M_\mathrm{init}=1-100\,\mathrm{M}_\odot \f].
