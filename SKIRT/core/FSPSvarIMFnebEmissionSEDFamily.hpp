...
#ifndef FSPSvarIMFnebEmissionSEDFAMILY_HPP
#define FSPSvarIMFnebEmissionSEDFAMILY_HPP
...
/** An instance of the FSPSvarIMFnebEmissionSEDFamily class represents a family of single stellar populations (SSPs)
    generated by the Flexible Stellar Population Synthesis (FSPS) code presented by Conroy, Gunn, &
    White (2009, ApJ, 699, 486) and Conroy & Gunn (2010, ApJ, 712, 833). These templates include nebular emission.
    The SED templates are parameterized on metallicity, age, IMF slope, and are scaled by the initial mass of the SSP.
...
class FSPSvarIMFnebEmissionSEDFamily : public SEDFamily
{
    ITEM_CONCRETE(FSPSvarIMFnebEmissionSEDFamily, SEDFamily, "an FSPS variable-IMF SED family for single stellar populations including nebular emission")
    ITEM_END()
...
public:
    /** This constructor can be invoked programmatically by classes that use a hard-coded SED
        ...
        */
    explicit FSPSvarIMFnebEmissionSEDFamily(SimulationItem* parent);
