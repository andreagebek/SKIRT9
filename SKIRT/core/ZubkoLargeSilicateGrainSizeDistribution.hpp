...
#ifndef ZUBKOLARGESILICATEGRAINSIZEDISTRIBUTION_HPP
#define ZUBKOLARGESILICATEGRAINSIZEDISTRIBUTION_HPP

#include "GrainSizeDistribution.hpp"

////////////////////////////////////////////////////////////////////

/** ZubkoLargeSilicateGrainSizeDistribution represents the dust grain size distribution and grain size
    range for the large silicate population in model BARE_GR_S of Zubko, Dwek & Arendt (2004, ApJS, 152,
...
class ZubkoLargeSilicateGrainSizeDistribution : public GrainSizeDistribution
{
    ITEM_CONCRETE(ZubkoLargeSilicateGrainSizeDistribution, GrainSizeDistribution,
                  "a Zubko, Dwek & Arendt size distribution for large silicate dust grains")
    ITEM_END()
...
public:
    ...
    explicit ZubkoLargeSilicateGrainSizeDistribution(SimulationItem* parent);
