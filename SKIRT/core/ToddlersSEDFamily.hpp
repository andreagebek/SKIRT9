...
/** An instance of the ToddlersSEDFamily class represents the family of star-forming 
    ...
    The TODDLERS model calculates the spherical evolution of a homogeneous gas cloud around a young stellar 
    ...
    - includeDust: Boolean flag determining dust processing in the SEDs:
      - true (default): 
        ...
        - In high resolution: Uses dust-attenuated emission lines (emergent luminosities) added to 
          the total emission after removing the low-resolution lines.
      - false: 
    ...
    1. Stellar age (Cloud mode only): The age of the stellar population
    ...
    where \f$t\f$ is the age of the stellar population, \f$Z\f$ is the metallicity, \f$\mathrm{SFE}\f$ is the 
    ...
    a power-law distribution (\f$dN/dM \propto M^{-1.8}\f$).
