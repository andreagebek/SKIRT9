...
#ifndef ZUBKOSMALLSILICATEGRAINSIZEDISTRIBUTION_HPP
#define ZUBKOSMALLSILICATEGRAINSIZEDISTRIBUTION_HPP

#include "GrainSizeDistribution.hpp"

////////////////////////////////////////////////////////////////////

/** ZubkoSmallSilicateGrainSizeDistribution represents the dust grain size distribution and grain size
    range for the small silicate population in model BARE_GR_S of Zubko, Dwek & Arendt (2004, ApJS, 152,
...
class ZubkoSmallSilicateGrainSizeDistribution : public GrainSizeDistribution
{
    ITEM_CONCRETE(ZubkoSmallSilicateGrainSizeDistribution, GrainSizeDistribution,
                  "a Zubko, Dwek & Arendt size distribution for small silicate dust grains")
    ITEM_END()
...
public:
    ...
    explicit ZubkoSmallSilicateGrainSizeDistribution(SimulationItem* parent);
