...
#ifndef FSPSvarIMFnebEmissionSED_HPP
#define FSPSvarIMFnebEmissionSED_HPP

#include "FamilySED.hpp"

////////////////////////////////////////////////////////////////////

/** FSPSvarIMFnebEmissionSED is a class that represents spectral energy distributions of simple stellar populations
    (SSPs), parameterized on metallicity, age and IMF slope, generated by the FSPS code presented by Conroy,
    Gunn, & White (2009, ApJ, 699, 486) and Conroy & Gunn (2010, ApJ, 712, 833). See the FSPSvarIMFnebEmissionSEDFamily
    class for more information. */
class FSPSvarIMFnebEmissionSED : public FamilySED
{
    ITEM_CONCRETE(FSPSvarIMFnebEmissionSED, FamilySED, "an FSPS variable-IMF simple stellar population SED including nebular emission")
