...
ZubkoSmallGraphiteGrainSizeDistribution::ZubkoSmallGraphiteGrainSizeDistribution(SimulationItem* parent)
{
...
double ZubkoSmallGraphiteGrainSizeDistribution::amin() const
{
    return amin_gra;
}
...
double ZubkoSmallGraphiteGrainSizeDistribution::amax() const
{
    return amax_gra;
}
...
double ZubkoSmallGraphiteGrainSizeDistribution::dnda(double a) const
{
    return dnda_gra(a);
}
