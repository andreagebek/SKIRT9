...
ZubkoLargeSilicateGrainSizeDistribution::ZubkoLargeSilicateGrainSizeDistribution(SimulationItem* parent)
{
...
double ZubkoLargeSilicateGrainSizeDistribution::amin() const
{
    return amin_sil;
}
...
double ZubkoLargeSilicateGrainSizeDistribution::amax() const
{
    return amax_sil;
}
...
double ZubkoLargeSilicateGrainSizeDistribution::dnda(double a) const
{
    return dnda_sil(a);
}
