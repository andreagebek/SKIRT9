...
ZubkoSmallSilicateGrainSizeDistribution::ZubkoSmallSilicateGrainSizeDistribution(SimulationItem* parent)
{
...
double ZubkoSmallSilicateGrainSizeDistribution::amin() const
{
    return amin_sil;
}
...
double ZubkoSmallSilicateGrainSizeDistribution::amax() const
{
    return amax_sil;
}
...
double ZubkoSmallSilicateGrainSizeDistribution::dnda(double a) const
{
    return dnda_sil(a);
}
